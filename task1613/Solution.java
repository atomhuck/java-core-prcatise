...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        if (dateTime.getDayOfWeek() == DayOfWeek.SATURDAY)
            return true;
        else if (dateTime.getDayOfWeek() == DayOfWeek.FRIDAY && dateTime.getHour() >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR)
            return true;
        else if (dateTime.getDayOfWeek() == DayOfWeek.SUNDAY && dateTime.getHour() < WEEKEND_END_SUNDAY_CUT_OFF_HOUR)
            return true;
